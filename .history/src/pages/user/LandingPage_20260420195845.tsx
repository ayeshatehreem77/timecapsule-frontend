...
export default function LandingPage() {
  useEffect(() => {
    AOS.init({
      duration: 1000, // Animation kitni der chale (ms mein)
      once: true,     // Kya animation sirf ek baar ho?
    });
  }, []);
return (
  <div className="landing-bg">
    ...
    <div style={{ position: "relative", zIndex: 1 }}>
      ...
      <nav className="navbar  navbar-expand-lg px-4">
        <div className="nav-logo h-100 w-100">
          <img src="/logo.svg" alt="create" />
      ...
      {/* 🔥 HERO SECTION */}
      <div className="container text-center mt-5 pt-5 hero-section vh-100" >
        ...
        <div className="mt-4">
          <div className="mt-5">
            <Link to="/register" className="cta-btn mt-5 text-decoration-none">
