  ...
  return (
    <div className="landing-bg">
      ...
      <header className="navbar-sticky">
        <nav className="navbar navbar-expand-lg px-4 navbar-dark">
          <div className="container-fluid d-flex align-items-center justify-content-between">

            {/* Logo section - removed h-100 w-100 */}
            <div className="nav-logo d-flex align-items-center" data-aos="fade-right">
              <img src="/tc-logo.svg" alt="logo" style={{ height: '60px' }} />
              <a className="navbar-brand ms-2 mb-0" href="#">TimeCapsule</a>
            </div>

            {/* Toggle button now stays on the right */}
            <button
