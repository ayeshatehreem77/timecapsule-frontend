    ...
    <div className="create-capsule-container fade-in">
      ...
      <div className="create-grid">
        ...
        >
          ...
          <label htmlFor="fileUpload" className="vessel-label">
            <p className="drop-text">
              {file ? `ATTACHED: ${file.name.toUpperCase()}` : "DRAG & DROP MEMORIES"}
            </p>
            ...
            <div className="main-vessel-display">
              ...
              <img
                ...
                alt="Vessel"
                className={file ? "floating-vessel active-vessel" : "floating-vessel"}
              />
            </div>
          </label>

          <p className="upload-hint">CLICK VESSEL TO SELECT MANUALLY</p>
        </div>
