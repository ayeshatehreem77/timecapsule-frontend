      ...
      <div className="identity-anchor-card">
        <div className="profile-main-info">
          <div className="avatar-wrapper">
             ...
             <img src="/icons/user-avatar.png" alt="Profile" className="profile-img" />
          </div>
        ...
        <div className="identity-stats">
          <div className="stat-item">
            <img src="/icons/capsule-teal.png" alt="vaults" className="stat-icon" />
            <div className="stat-text">
                <span className="stat-label">TOTAL VAULTS:</span>
                <span className="stat-value">{user.totalCapsules || 22}</span>
            </div>
          </div>
          <div className="stat-divider"></div>
          <div className="stat-text-single">
            <span className="stat-label">DATA SECURED:</span>
            <span className="stat-value-gold">1.2 TB</span>
          </div>
        </div>
      </div>
