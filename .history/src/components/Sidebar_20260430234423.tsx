  ...
  return (
    <div className="sidebar p-3 d-flex flex-column">
      ...
      <div className="mt-4">
        ...
        >
          <img src='/user.png' alt=''></img> My Profile
        </div>
        ...
        >
          <img src='/history.png' alt=''></img> Create Capsule
        </div>
        ...
        >
          <img src='/active-vault.png' alt=''></img> Active Vaults
        </div>
        ...
        >
          <img src='/legacy.png' alt=''></img> legacy
        </div>
